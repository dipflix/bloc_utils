...
/// @nodoc
abstract class $BlocDynamicStateCopyWith<T, $Res> {
  factory $BlocDynamicStateCopyWith(
          BlocDynamicState<T> value, $Res Function(BlocDynamicState<T>) then) =
      _$BlocDynamicStateCopyWithImpl<T, $Res, BlocDynamicState<T>>;
}

/// @nodoc
class _$BlocDynamicStateCopyWithImpl<T, $Res, $Val extends BlocDynamicState<T>>
    implements $BlocDynamicStateCopyWith<T, $Res> {
  _$BlocDynamicStateCopyWithImpl(this._value, this._then);
...
class __$$LoadingStateImplCopyWithImpl<T, $Res>
    extends _$BlocDynamicStateCopyWithImpl<T, $Res, _$LoadingStateImpl<T>>
...
abstract class LoadingState<T> implements BlocDynamicState<T> {
...
class __$$SuccessStateImplCopyWithImpl<T, $Res>
    extends _$BlocDynamicStateCopyWithImpl<T, $Res, _$SuccessStateImpl<T>>
...
abstract class SuccessState<T> implements BlocDynamicState<T> {
...
class __$$ErrorStateImplCopyWithImpl<T, $Res>
    extends _$BlocDynamicStateCopyWithImpl<T, $Res, _$ErrorStateImpl<T>>
...
abstract class ErrorState<T> implements BlocDynamicState<T> {
...
class __$$EmptyStateImplCopyWithImpl<T, $Res>
    extends _$BlocDynamicStateCopyWithImpl<T, $Res, _$EmptyStateImpl<T>>
...
class _$EmptyStateImpl<T> implements EmptyState<T> {
...
abstract class EmptyState<T> implements BlocDynamicState<T> {
  const factory EmptyState() = _$EmptyStateImpl<T>;
}
